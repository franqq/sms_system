...
<div class="row">
           ...
           <div style ="text-align:center;"> 
            ...
            <div class="box-content row">
                <div class="col-lg-7 col-md-12">
                   <form class="form-horizontal" role="form" action="{{URL::route('reports-post')}}" method="post">
 <div  style="float:left;margin-left:10px;">
  ...
  <th>Date To</th>
    ...
    <tbody>
    <tr>
	<td class="center">{{date("m-d-Y",strtotime($startdate))}}</td>
  <td class="center">{{date("m-d-Y",strtotime($enddate))}}</td>
  <td class="center">{{$totalmessages}}</td>
  <td class="center">Kes {{$cost}}</td>
	<td class="center">Kes {{$bal}}</td>
