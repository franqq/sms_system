...
<div class="modal fade" id="mysecondModal{{$member->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form class="form-horizontal" role="form" action="{{URL::route('editmember-post')}}" method="post">
  <div class="form-group">
   ...
   <label for="inputfirstname" class="col-sm-2 control-label">Firstname</label>
    ...
    <div class="col-sm-10">
     ...
     @if($errors->has('National_ID'))
            <div style="color:#990000; text-align:center;>{{$errors->first('National_ID')}}</div>
     @endif
  </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <form id="deleteinfo" action="{{URL::route('deletemember-post')}}" method="post">
