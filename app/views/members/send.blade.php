...
<div style ="text-align:center;"> 
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10" style="margin-bottom:15px;">
      <input type="text" class="form-control" id="inputmobilenumber" name="Phone_Number" required="required" placeholder="Enter the phone numbers and separate with a comma*"
